...
const Header = () => {
  ...
  return (
    <div className="font-urbanist w-full absolute top-0 left-0 right-0 z-10">
      {/* top navigation */}
      <div className="flex justify-end text-sm text-white my-3 max-w-[1290px] mx-auto">
      ...
      {/* main navigations */}
      <div
        className={` navbar min-h-[72px] z-10  h-[72px] bg-white max-w-[1290px] mx-auto lg:rounded-sm px-5 mt-4 text-neutral ${scroll &&
